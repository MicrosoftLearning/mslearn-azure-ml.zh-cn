...
1. 等待脚本完成 - 这通常需要大约 5-10 分钟。
    ...
    <ol>
        ...
        <li>在 Azure 机器学习工作室中，导航到“<b>数据</b>”页，然后选择<b>+“创建”</b>。</li>
        <li>命名数据资产 <b>diabetes-data</b>，并验证是否选择了<b>文件 (uri_file)</b> 类型。 选择<b>下一步</b>。</li>
        <li>选择“<b>来自本地文件</b>”作为数据源，然后选择“<b>下一步</b>”。</li>
        <li>验证是否已选择“<b>Azure Blob 存储</b>”和 <b>workspaceblobstore</b> 分别作为目标存储类型和数据存储。 选择<b>下一步</b>。</li>
        <li>上传之前下载的 .csv 文件，然后选择“<b>下一步</b>”。</li>
        <li>查看数据资产的设置，然后选择“<b>创建</b>”。</li>
    </ol>
    </details>
